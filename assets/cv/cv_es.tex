...
Domicilio:& \href{https://www.google.com.uy/maps/@-34.8822456,-55.0512462,17z?hl=es-419}{Juana de Am\'{e}rica esq. Para\'{i}so}, Pta. Ballena, Uruguay\\
Web: & \href{http://marcelo-forets.fr}{\url{http://marcelo-forets.fr}}\\
Celular: & (+598)(0)92-079-370 \\
Email: & \href{mailto:mforets@gmail.com}{mforets@gmail.com} \\
CVUy: & \href{https://exportcvuy.anii.org.uy/cv/?ae95302988f85483fe4321b03ff897a096b3b73016ca199f83bfaf5e673ba15cd8ea7e1417176b8137e2cf5a55409355ec23830659e3efbb6a2bd068aea4b231}{Link al CVUy web (incluye lista completa de publicaciones)}%\\
\end{tabular}
...
% perfil cientifico
Marcelo Forets es un Doctor en Matemáticas Aplicadas que trabaja en métodos matemá-ticos, físicos y computacionales aplicados a las Ciencias y la Ingeniería. %Su trabajo se encuentra en la frontera de la matemática aplicada y la verificación formal para los sistemas  híbridos  y de control.
...
\item[-] {\textbf{Doctorat en Math\'ematiques et Informatique}}% à l'\'Ecole Doctorale MSTII
	\begin{innerlist}
		\item[-] Escuela Doctoral: MSTII (Matemáticas, Ciencias de la Tecnología y de la Informatión e Informática)
	...
	\item[-] Directores de tesis: \href{http://pageperso.lif.univ-mrs.fr/~pablo.arrighi/}{Pablo Arrighi} (director) y \href{http://www-fourier.ujf-grenoble.fr/~joye/}{Alain Joye} (co-tutor).
	\item[-] Palabras clave: computación cuántica, mecánica cuántica discreta, simulación de sistemas cuánticos en interacción, análisis espectral, caminatas cuánticas, mecánica cuántica relativista.
	\end{innerlist}
...
\href{http://www.utec.edu.uy}{\textbf{Univeresidad Tecnológica del Uruguay}}, Durazno, Uruguay
...
\begin{itemize}
	...
	\item[-]  Traducción y revisión en: \href{https://hal.archives-ouvertes.fr/hal-01646401}{\emph{Mathematical Computation with SageMath}} Alexandre Casamayou, Nathann Cohen, Guillaume Connan, Thierry Dumont, Laurent Fousse, et al.. En proceso de publicación.
\end{itemize}
