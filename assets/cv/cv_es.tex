...
% perfil cientifico
Marcelo Forets es un investigador que trabaja en métodos computacionales, físicos y matemáticos, aplicados a las Ciencias y la Ingeniería. %Su trabajo se encuentra en la frontera de la matemática aplicada y la verificación formal para los sistemas  híbridos  y de control.
Se interesa por establecer puentes entre la investigación teórica y sus aplicaciones en las distintas áreas de desarrollo del país. 
...
\begin{outerlist}
	...
	\begin{innerlist}
		\item[-] Investigador de Post-Doctorado en el laboratorio \href{http://www-verimag.imag.fr/?lang=en}{VERIMAG}, grupo TEMPO (Timed and Hybrid Systems group). 
		...
		\item[-] NANO2017. Estudio de la variabilidad de circuitos electrónicos analógicos. Colaboración entre la Univ. Grenoble Alpes y la compañía ST Microelectronics.
	\end{innerlist}
\end{outerlist}
